      ...
      <div className="bg-slate-900 w-full max-w-md rounded-2xl shadow-2xl border border-slate-800 overflow-hidden animate-slide-up">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          <div className="relative">
            ...
            <input type="text" value={title} onChange={(e) => setTitle(e.target.value)} placeholder="Es. Pagare bolletta" className="w-full text-xl font-bold text-slate-100 placeholder-slate-700 outline-none border-b border-slate-700 focus:border-indigo-500 pb-2 pr-10 bg-transparent" autoFocus required />
